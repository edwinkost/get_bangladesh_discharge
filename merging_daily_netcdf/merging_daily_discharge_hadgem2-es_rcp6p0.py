...
#~ edwinhs@fcn1.bullx:/projects/0/aqueduct/users/edwinsut/pcrglobwb_runs_2017_feb_rcp6p0/pcrglobwb_4_land_covers_edwin_parameter_set_hadgem2-es/no_correction/rcp6p0$ ls -lah */M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 3.1G Feb 23  2017    begin_from_2006/M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 3.1G Feb 24  2017 continue_from_2037/M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 3.1G Apr 30  2017 continue_from_2067/M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 201M Apr 30  2017 continue_from_2098/M17/netcdf/discharge_dailyTot_output.nc
...
# output folder
output_folder = "/scratch-shared/edwinhs/daily_discharge_aqueduct_flood_analyzer/m17/hadgem2-es/rcp6p0/"
