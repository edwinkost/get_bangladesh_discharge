...
#~ edwinhs@fcn26.bullx:/projects/0/aqueduct/users/edwinsut/pcrglobwb_runs_2017_feb_rcp6p0/pcrglobwb_4_land_covers_edwin_parameter_set_gfdl-esm2m/no_correction/rcp6p0$ ls -lah */M17/netcdf/discharge_dailyTot_output.nc 
#~ -r-xr--r-- 1 edwinsut aqueduct 3.0G Feb 23  2017    begin_from_2006/M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 2.9G Feb 24  2017 continue_from_2036/M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 2.9G Apr 30  2017 continue_from_2065/M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 598M Apr 30  2017 continue_from_2094/M17/netcdf/discharge_dailyTot_output.nc
...
# output folder
output_folder = "/scratch-shared/edwinhs/daily_discharge_aqueduct_flood_analyzer/m17/gfdl-esm2m/rcp6p0/"
