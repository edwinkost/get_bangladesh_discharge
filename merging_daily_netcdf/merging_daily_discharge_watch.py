...
#~ edwinhs@fcn26.bullx:/projects/0/aqueduct/users/edwinsut/pcrglobwb_runs_2016_oct_nov/pcrglobwb_4_land_covers_edwin_parameter_set_watch_kinematicwave/no_correction/non-natural$ ls -lah */M17/netcdf/discharge_dailyTot_output.nc 
#~ -r-xr-xr-x 1 edwinsut aqueduct 1.8G Nov 16  2016 begin_from_1958/M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr-xr-x 1 edwinsut aqueduct 115M Nov 16  2016 begin_from_1958_only_test/M17/netcdf/discharge_dailyTot_output.nc - NOT USED
#~ -r-xr-xr-x 1 edwinsut aqueduct 909M Nov  1  2016 continue_from_1976/M17/netcdf/discharge_dailyTot_output.nc
#~ -r-xr-xr-x 1 edwinsut aqueduct 1.7G Nov 16  2016 continue_from_1985/M17/netcdf/discharge_dailyTot_output.nc
...
# output folder
output_folder = "/scratch-shared/edwinhs/daily_discharge_aqueduct_flood_analyzer/m17/watch/historical_baseline/"
