...
#~ edwinhs@fcn1.bullx:/projects/0/aqueduct/users/edwinsut/pcrglobwb_runs_2017_feb_rcp6p0/pcrglobwb_4_land_covers_edwin_parameter_set_miroc-esm-chem/no_correction/rcp6p0$ ls -lah */M13/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 3.1G Feb 23  2017    begin_from_2006/M13/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 3.0G Feb 24  2017 continue_from_2037/M13/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 3.1G Apr 30  2017 continue_from_2067/M13/netcdf/discharge_dailyTot_output.nc
#~ -r-xr--r-- 1 edwinsut aqueduct 199M Apr 30  2017 continue_from_2098/M13/netcdf/discharge_dailyTot_output.nc
...
# output folder
output_folder = "/projects/0/dfguu2/scratch/edwin/daily_discharge_aqueduct_flood_analyzer/m13/miroc-esm-chem/rcp6p0/"
